...
class _EnhanceExpansionPanelListState extends State<EnhanceExpansionPanelList> {
  ...
  void initState() {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      assert(_allIdentifiersUnique(),
          'All EnhanceExpansionPanelRadio identifier values must be unique.');
      if (widget.initialOpenPanelValue != null) {
        _currentOpenPanel = searchPanelByValue(
            widget.children.cast<EnhanceExpansionPanelRadio>(),
  ...
  bool _allIdentifiersUnique() {
    ...
    for (final EnhanceExpansionPanelRadio child
        in widget.children.cast<EnhanceExpansionPanelRadio>()) {
  ...
  bool _isChildExpanded(int index) {
    if (widget._allowOnlyOnePanelOpen) {
      final EnhanceExpansionPanelRadio radioWidget =
          widget.children[index] as EnhanceExpansionPanelRadio;
  ...
  void _handlePressed(bool isExpanded, int index) {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      final EnhanceExpansionPanelRadio pressedChild =
          widget.children[index] as EnhanceExpansionPanelRadio;
      ...
      for (int childIndex = 0;
          ...
          childIndex += 1) {
        final EnhanceExpansionPanelRadio child =
            widget.children[childIndex] as EnhanceExpansionPanelRadio;
  ...
  EnhanceExpansionPanelRadio? searchPanelByValue(
      List<EnhanceExpansionPanelRadio> panels, Object? value) {
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      if (_isChildExpanded(index) &&
        ...
        items.add(
          MaterialGap(
            key: _SaltedEnhanceKey<BuildContext, int>(context, index * 2 - 1),
            size: widget.materialGap,
          ),
        );
      }
      ...
      Widget expandIconContainer =
          child.arrowPosition == EnhanceExpansionPanelArrowPosition.none
              ? Container()
              : Container(
      ...
      Widget header = Row(
        children: <Widget>[
          if (child.arrowPosition != EnhanceExpansionPanelArrowPosition.none &&
              child.arrowPosition == EnhanceExpansionPanelArrowPosition.leading)
            expandIconContainer,
          Expanded(
          ...
          if (child.arrowPosition != EnhanceExpansionPanelArrowPosition.none &&
              child.arrowPosition == EnhanceExpansionPanelArrowPosition.tailing)
            expandIconContainer,
        ],
      );
      if (child.canTapOnHeader) {
    ...
    return MergeableMaterial(
      hasDividers: widget.dividerColor != null,
