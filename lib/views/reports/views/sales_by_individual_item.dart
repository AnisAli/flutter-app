...
class SalesByIndividualItem extends GetView<SalesByIndividualItemController> {
  static const String routeName = '/salesByIndividualItem';

  const SalesByIndividualItem({super.key});
  ...
  Widget _buildSimpleAppBar(BuildContext context) {
    return SliverAppBar(
      ...
      centerTitle: true,
      title: Text(
        AppStrings.SALES_BY_INDIVIDUAL_ITEM,
          ...
          children: [
            ...
            Expanded(
              child: CustomDropDownField<String>(
                ...
                onChange: controller.onCustomerFilterChange,
                items: controller.customerFilters,
                selectedItem: controller.customerFilter,
                verticalPadding: 10,
              ),
            ),
            const SpaceW4(),
                        ...
                        children: [
                          Container(
                            ...
                            child: _buildReportRow(
                              context,
                              {
                                'date': AppStrings.DATE.capitalize,
                                'item': AppStrings.ITEM.capitalize,
                                'description':
                                    AppStrings.DESCRIPTION.capitalize,
                                'order': AppStrings.ORDER.capitalize,
                                'customer': AppStrings.CUSTOMER.capitalize,
                                'quantity': AppStrings.QUANTITY.capitalize,
                                'salePrice': AppStrings.SALES_PRICE.capitalize,
                                'amount': AppStrings.AMOUNT.capitalize,
                              },
                            ),
                          ),
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Container(
                                ...
                                child: _buildReportRow(
                                  context,
                                  {
                                    'date': controller.reportData[index].date,
                                    'item': controller.reportData[index].item,
                                    'description': controller
                                        .reportData[index].description,
                                    'order': controller
                                        .reportData[index].orderNumber,
                                    'customer': controller
                                        .reportData[index].customerName,
                                    'quantity':
                                        (controller.reportData[index].quantity)!
                                            .toString(),
                                    'salePrice': formatCurrency(controller
                                        .reportData[index].salePrice!),
                                    'amount': formatCurrency(
                                        controller.reportData[index].amount!),
                                  },
                                ),
                              );
                            },
