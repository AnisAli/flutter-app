...
class SalesByItem extends GetView<SalesByItemController> {
  static const String routeName = '/salesByItem';
                        ...
                        children: [
                          Container(
                            ...
                            child: _buildReportRow(
                              context,
                              {
                                'title': AppStrings.PRODUCT.capitalize,
                            ...
                            itemBuilder: (context, index) {
                              return SizedBox(
                                ...
                                child: _buildReportRow(
                                  ...
                                  {
                                    'title':
                                        '${controller.reportData[index].item}',
                                    'quantity':
                                        controller.reportData[index].quantity!,
                                    'amount':
                                        formatCurrency(controller.reportData[index].subTotal!),
                                    'cogs':
                                        formatCurrency(controller.reportData[index].cogs!),
                                    'net':
                                        formatCurrency(controller.reportData[index].netTotal!),
                                    'gain':
                          ...
                          Container(
                            ...
                            height: 50,
                            child: GetBuilder<SalesByItemController>(
                              id: 'totalData',
