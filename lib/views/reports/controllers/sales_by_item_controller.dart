...
class SalesByItemController extends GetxController with StateMixin {
  ...
  Future<void> getReport() async {
    ...
    try{
      reportData = await BaseClient.safeApiCall(
        ApiConstants.ORDER_ITEM_SUMMARY,
        RequestType.post,
        headers: await BaseClient.generateHeaders(),
        data: {
        ...
        onSuccess: (json) {
          ...
          if (json.data != null) {
            json.data.forEach((v) {
              data.add(ReportModel.fromSalesByItem(v));
            });
          }
          return data;
        },
  ...
  Future<void> getPDF() async {
    ...
    try {
      ...
      String path = "${dir.path}/SalesByItemReport.pdf";
      ...
      String apiString = "${ ApiConstants.ORDER_ITEM_SUMMARY}?export=pdf";
