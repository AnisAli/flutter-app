...
class SalesByCustomerController extends GetxController with StateMixin {
  ...
  // Define the selectedCustomer variable as an Rx<CustomerModel>
  ...
  ReportModel totalReportData = ReportModel(
    quantity: 0.0,
    subTotal: 0.0,
    cogs: 0.0,
    netTotal: 0.0,
  ...
  //List<String> customerFilters = ['All'];
  ...
  Future<void> getReport() async {
    ...
    totalReportData.quantity = 0.0;
    totalReportData.subTotal = 0.0;
    totalReportData.cogs = 0.0;
    totalReportData.netTotal = 0.0;
    totalReportData.gain = 0.0;
    ...
    try {
      reportData = (await BaseClient.safeApiCall(
        ...
        onSuccess: (json) {
          ...
          if (json.data != null) {
            json.data.forEach((v) {
              data.add(ReportModel.fromSalesByCustomer(v));
            });
          }
          return data;
        },
      ...
      for (var value in reportData) {
        totalReportData.quantity = totalReportData.quantity! + value.quantity!;
        totalReportData.cogs = totalReportData.cogs! + value.cogs!;
        totalReportData.subTotal = totalReportData.subTotal! + value.subTotal!;
      }
      totalReportData.netTotal =
          totalReportData.quantity! - totalReportData.cogs!;
      totalReportData.gain =
          (totalReportData.netTotal! * 100) / totalReportData.quantity!;
      update(['totalData']);
  ...
  Future<void> getPDF() async {
    ...
    try {
      ...
      String path = "${dir.path}/SalesByCustomerReport.pdf";
      ...
      String apiString = "${ApiConstants.CUSTOMER_ITEM_SUMMARY}?export=pdf";
